package com.ems.codingtestarshad.api

import com.ems.codingtestarshad.BuildConfig
...
interface RetrofitClient {
    ...
    companion object {
        ...
        private val client = OkHttpClient.Builder()
            ...
            .addInterceptor(Interceptor { chain ->
                ...
                request = request.newBuilder().url(urlBuilder.build()).addHeader("Accept-Encoding","identity").build();
                try {
    ...
    suspend fun getUserData(): List<HomeResponseItem>
}